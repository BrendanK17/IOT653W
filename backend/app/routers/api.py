...
@router.get("/llm")
def query_ollama(prompt: str = Query("Why is the sky blue?", description="Prompt for the LLM")):
...
def query_climatiq(
    ...
    source_lca_activity: str = Query("fuel_combustion", description="Source LCA activity")
):
